...
public class Dispersiones {
    ...
    public Dispersiones(Integer beneficiarioId, BigDecimal monto, LocalDateTime fecha, Integer usuarioId, String estado) {
    ...
    public String toString() {
        return String.format("Dispersion[id=%d, beneficiarioId=%d, monto=%s, estado='%s']", id, beneficiarioId, monto, estado);
    }
}
